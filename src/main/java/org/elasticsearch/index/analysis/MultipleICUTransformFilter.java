...
public final class MultipleICUTransformFilter extends TokenFilter {
    ...
    public MultipleICUTransformFilter(TokenStream input, Transliterator[] transforms) {
        super(input);
        this.transforms = transforms;

        /*
         * This is cheating, but speeds things up a lot. If we wanted to use pkg-private APIs we
    ...
    public boolean incrementToken() throws IOException {
        ...
        while (true) {
            ...
            if (currentTransform < transforms.length) {
                ...
                transforms[currentTransform++].filteredTransliterate(replaceableAttribute, position, false);
                return true;
            }
            curTermBuffer = null;
        }
